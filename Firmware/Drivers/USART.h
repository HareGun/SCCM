...
#define USART1_TX_ADDR						(uint32_t)(&USART1->DR)	//串口1数据寄存器地址
#define USART1_TX_DMA_CHANNEL           	DMA1_Channel4		//DMA通道号
...
extern uint8_t USART1_buff[USART2_BUFFLEN];
...
void USART1_TXDMA_Config(uint32_t USART1_DMABuff_addr, uint32_t buffsize);
