...
//	CAN_FilterInitStructure.CAN_FilterMaskIdLow = 0x0000;			//筛选器低16位每位不须匹配
  ...
  //仅接收单个ID
  CAN_FilterInitStructure.CAN_FilterIdHigh = CAN1_FILTER_ID_HIGH;				//要筛选的ID高位 
	CAN_FilterInitStructure.CAN_FilterIdLow = CAN1_FILTER_ID_LOW; 				//要筛选的ID低位 
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = CAN1_FILTER_MASK_ID_HIGH;		//筛选器高16位每位必须匹配
	CAN_FilterInitStructure.CAN_FilterMaskIdLow = CAN1_FILTER_MASK_ID_LOW;			//筛选器低16位每位必须匹配
